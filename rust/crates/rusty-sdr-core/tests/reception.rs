...
//!
//! Run with:
//!   cargo test -p rusty-sdr-core --features hardware_tests --test reception
//!
...
impl HardwareFixture {
    ...
    fn start() -> Option<Self> {
        ...
        use rusty_sdr_core::source::Source as _;
        let iq_rx = source.subscribe();

        // Start the source task.
        use rusty_sdr_core::block::Block as _;
...
fn test_quality_report_and_wav_output() {
    ...
    println!("\n╔══════════════════════════════════════════╗");
    println!("║    Rusty SDR Reception Quality Report    ║");
    println!("╠══════════════════════════════════════════╣");
