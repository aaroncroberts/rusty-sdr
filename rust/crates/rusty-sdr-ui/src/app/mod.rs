...
use rusty_sdr_recorder::RecorderCommand;
...
pub struct SdrApp {
    ...
    bookmark_edit_buf: (String, String, rusty_sdr_core::signal_path::DemodMode, String, u32, f32, bool, Option<String>),
    ...
    adsb_iq_tx: Option<tokio::sync::broadcast::Sender<std::sync::Arc<[rusty_sdr_core::sample::IqSample]>>>,
    ...
    pub fn new(
        ...
        Self {
            ...
            bookmark_edit_buf: (
                String::new(),
                String::new(),
                rusty_sdr_core::signal_path::DemodMode::Wbfm,
                String::new(),
                12_500_u32,
                -50.0_f32,
                false,
...
pub(crate) fn parse_config_demod_mode(s: &str) -> rusty_sdr_core::signal_path::DemodMode {
    ...
    pub(in crate::app) fn restore_bookmark_antenna(&mut self) {
        if let Some(prev) = self.bookmark_prev_antenna.take() {
            ...
            let _ = self.cmd_tx.try_send(
                rusty_sdr_core::signal_path::HardwareCommand::SetAntenna(port).into(),
            );
