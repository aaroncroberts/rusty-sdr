    ...
    HandbookPage::new(vec![
        ...
        ContentBlock::Body(
            "The Korg nanoKontrol2 is a compact USB MIDI controller with 8 channel strips, \
             ...
             CYCLE button that Rusty SDR uses to switch between three control pages.",
        ),
        ...
        ContentBlock::Body(
            "Click the ▶ Mapper button in the MIDI section of the right panel. \
             ...
             labelled with its current Rusty SDR assignment.",
        ),
    ])
}
...
fn page_nanokontrol_pages() -> HandbookPage {
    HandbookPage::new(vec![
        ...
        ContentBlock::Body(
            "Rusty SDR maps the nanoKontrol2 across three logical pages, switched by the \
