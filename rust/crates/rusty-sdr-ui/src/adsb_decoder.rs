...
use rusty_sdr_core::sample::IqSample;
use rusty_sdr_adsb::{
...
mod tests {
    use super::*;
    use rusty_sdr_adsb::{crc24, state::AircraftStore, PREAMBLE_LEN, SAMPLES_PER_BIT};

    // Preamble high-sample positions (not re-exported from rusty_sdr_adsb).
    ...
    fn decoder_populates_store_from_synthetic_iq() {
        ...
        let silence_needed = PREAMBLE_LEN + rusty_sdr_adsb::LONG_MSG_BITS * SAMPLES_PER_BIT;
