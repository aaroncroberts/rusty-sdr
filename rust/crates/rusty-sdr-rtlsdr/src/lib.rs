...
//!
//! ```rust,ignore
//! if rusty_sdr_rtlsdr::RtlSdrSource::is_device_available() {
//!     let mut src = rusty_sdr_rtlsdr::RtlSdrSource::open(0, cfg).unwrap();
...
/// RTL-SDR IQ source.
///
/// Wraps an RTL-SDR dongle as an [`rusty_sdr_core::source::Source`].
